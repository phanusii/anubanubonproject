...
2. กรอก **Email** = อีเมลแอดมินของคุณ (ต้องตรงกับที่กำหนดใน `firestore.rules`)
...
> อย่านำอีเมลผู้ดูแลออกจาก `firestore.rules` เพราะกฎนี้ป้องกันการแก้ไขข้อมูลหลังบ้าน

### 4. เปลี่ยนอีเมลแอดมินใน Rules (ถ้าใช้อีเมลอื่น)
เปิด `firestore.rules` แล้วแก้ค่าอีเมลในฟังก์ชัน `adminEmail()`
