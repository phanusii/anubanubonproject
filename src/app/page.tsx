...
/**
 * Single-page public shell. Home / submit / gallery / person / stats are swapped
 * client-side via the URL hash — no full page reload between them.
 * Admin (/admin/*) stays on its own separate routes.
 */
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 w-full flex flex-col">
        {view === "home" && <HomeSection onOpenPerson={openPerson} />}
